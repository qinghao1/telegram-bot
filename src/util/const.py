...
DINNER_DESC = (
    f"{DINNER_COMMAND} - view dinner menu today. Dinner is served 5:30-9:30AM daily.\n"
)
...
ADD_FAVORITE_DESC = (
    f"{ADD_FAVORITE_COMMAND} [FOOD] - add favorite food for notifications\n"
)
REMOVE_FAVORITE_COMMAND = "/remove_favorite"
REMOVE_FAVORITE_DESC = (
    f"{REMOVE_FAVORITE_COMMAND} - remove favorite food from notifications\n"
)
NO_FAVORITES_MSG = (
    f"You have no favorite foods! Use {ADD_FAVORITE_COMMAND} [FOOD] to add one!"
)
HELP_COMMAND = "/help"
HELP_DESC = f"{HELP_COMMAND} - show the help message\n"
SET_BREAKFAST_NOTIFICATION_COMMAND = "/subscribe_breakfast"
SET_BREAKFAST_NOTIFICATION_DESC = (
    f"{SET_BREAKFAST_NOTIFICATION_COMMAND} "
    f"- subscribe to breakfast broadcast at <b>12AM</b> daily.\n"
)
SET_DINNER_NOTIFICATION_COMMAND = "/subscribe_dinner"
SET_DINNER_NOTIFICATION_DESC = (
    f"{SET_DINNER_NOTIFICATION_COMMAND} "
    f"- subscribe to dinner broadcast at <b>3PM</b> daily.\n"
)
CHECK_RVRC_DINING_COUNT_COMMAND = "/rvcount"
CHECK_RVRC_DINING_COUNT_DESC = (
    f"{CHECK_RVRC_DINING_COUNT_COMMAND} "
